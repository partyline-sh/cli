...
func realTaskExec(repo string, o crankOpts, logger *runLogger) taskExec {
	return func(i int, task string) crankResult {
		...
		out, werr := runWorker(wtPath, task, o.model, o.thread, o.allowBash, o.timeout, logger.sink(i), resume)
		...
		if resume != "" && werr != nil && out.resumeHandle == "" && out.rateReset.IsZero() {
			...
			out, werr = runWorker(wtPath, task, o.model, o.thread, o.allowBash, o.timeout, logger.sink(i), "")
		}
