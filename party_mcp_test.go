...
func TestMCPToolsListAdvertisesAllTools(t *testing.T) {
	...
	for _, want := range []string{"read_channel", "read_transcript", "post", "who", "help", "read_doc", "propose_edit", "ask_human", "propose_fix", "plan_read", "plan_upsert", "plan_move", "plan_propose"} {
		if !got[want] {
