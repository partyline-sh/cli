...
type installConfig struct {
	...
	minio     bool // run the bundled MinIO; default OFF — attachments stay dark until enabled
	tls       tlsMode
...
Safe to re-run: it reconciles, and never rewrites the .env holding your secrets.
  ...
  --with-minio       run the bundled MinIO for attachments (default: off — the
                     feature stays dark and two fewer containers run)
