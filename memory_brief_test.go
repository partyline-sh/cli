...
func TestBriefIsCapped(t *testing.T) {
	...
	out := renderBrief("acr", "fleet-manager", many)
...
func TestConflictsAcrossScopes(t *testing.T) {
	...
	out := renderBrief("acr", "fleet-manager", facts)
...
func TestNoFalseConflicts(t *testing.T) {
	...
	if strings.Contains(renderBrief("acr", "", same), "disagree") {
	...
	if strings.Contains(renderBrief("acr", "", unrelated), "disagree") {
