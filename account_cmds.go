...
func loginMain(args []string) {
	...
	// any more, so that would start a device flow against a documentation site and report whatever
	// a 404 looks like. Refuse with the two things that actually work instead.
