...
func runLLMSApp(initial []ptymux.Spec) error {
	...
	startPeerAskAdopter(mx, api.New())                                  // ask_peer: watch for answers to asks the AGENT made, and deliver them
	startSessionAskWatch(mx)                                            // ask_session: carry questions between this window's own sessions
