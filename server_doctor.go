...
func serverDoctorMain(args []string) {
	...
	// Not an error: a box that deliberately runs without Stripe is correctly configured. The exit
	// code stays 0 so this is safe in a deploy script that only cares about a crash.
}
