...
// announceMemoryChanged tells the project that its memory moved. Best-effort by design: a
// failure here is a slower teammate, not a lost fact, so it neither blocks the write nor
// reports an error to the person who made it.
