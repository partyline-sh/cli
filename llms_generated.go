...
//
// Agent harnesses (tool unidentified — shape-based rule, no vendor knowledge) spawn engine sessions inside per-session workspace
...
// (observed on a first install). The cwd is truthful; the PRESENTATION is the bug.
//
