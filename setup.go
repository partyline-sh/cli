...
//
// Six checks in dependency order — account, worker, engine, projects, pull requests, agent
// memory. A finished step shows ✓ and is never redone; a gap either asks ONE question (on a
...
func setupMain() {
	...
	// ── 4 · Projects — a node with nothing bound receives no work ───────────
