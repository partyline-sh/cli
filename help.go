...
COMMANDS
  ...
  describe       Requirements Agent: interview a rough idea into a well-specified,
                 SCORED backlog item (Epic/Feature/Task) in the planning tree — runs
                 your local claude (your auth, no server key). ptln describe
                 [--kind epic|feature|task] [--thread <id>] [--quick]. /quick /deep to
                 switch modes mid-interview, /done, /quit. (In-session twin: /describe.)
