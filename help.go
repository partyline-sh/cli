...
USAGE
  ...
  ptln new <tool>      start a fresh AI session — claude | codex | gemini | antigravity
                       (add --thread <id> to attach it to a Common Ground thread)
...
COMMANDS
  ...
  party          interactive: start a new party, or join a running team party
  ...
  thread         shared context across people/machines/engines (Common Ground):
...
AI SESSIONS (local)
  ptln llms              browse your AI CLI sessions in an interactive menu.
                ...
                [ scroll back · c context (record/view shared context) ·
                s share (open a shared terminal in a new tab) ·
