...
COMMANDS
  ...
  peer           peer consults — read-only Q&A between your agents and a teammate's.
                 ...
                 machine; agents ask with the ask_peer MCP tool, and ctrl-\ p is the
                 inbox (ask someone, read replies). See PEER CONSULTS below
...
AI SESSIONS (local)
  ptln llms              browse your AI CLI sessions in an interactive menu.
                ...
                p peer (ask a teammate's agent a read-only question, and read the
                questions + replies waiting for you — see PEER CONSULTS) ·
...
PEER CONSULTS (read-only Q&A between your agents and a teammate's)
  ...
  ctrl-\ p       the inbox, inside ptln: ask a peer, and read the questions + replies
                 waiting for you.
