...
COMMANDS
  ...
  llms           session launcher: browse, run, and cycle your AI CLI sessions
                 (claude/codex/gemini/llm) — all in one terminal; once live,
                 ctrl-\ w lists open sessions to switch between (or n/p to cycle)
  mux [<id>...]  same launcher, pre-opening the given sessions into live windows
...
AI SESSIONS (local)
  ptln llms              browse your AI CLI sessions in an interactive menu.
                Keys: arrows move · / search · s cycle sort (recent/oldest/
  ...
  ptln llms resume <id>  resume by id or unique prefix
