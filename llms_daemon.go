...
// joinableChanged is called after a [P] cycle. If Online, it re-advertises so a teammate's
// picker stays current; if Offline it just no-ops (the next goOnline mirrors fresh).
