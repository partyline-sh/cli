...
func TestReferencePromptIsByteIdenticalToTheServedArtifact(t *testing.T) {
	// Serialized against the drift-gate tests, which hand-edit this very file in the working
	// tree to prove the gate notices. See internal/artifactlock.
	defer artifactlock.Acquire()()
