...
| Deploy | `deploy/docker-compose.yml`, `deploy/Caddyfile`; `.github/workflows/deploy-hetzner.yml` (web), `release.yml` (CLI on tag) |
| Deep design docs | `docs/` — `ARCHITECTURE.md`, `COMMON-GROUND.md`, `DAEMON-MVP.md`, `FLEET.md`, `PARTY.md`, `BILLING.md`, … |
