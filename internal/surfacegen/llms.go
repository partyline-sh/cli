...
each is running, /threads holds the shared context, and /history is the log of what happened.
...
var anchorRoutes = []string{"/describe", "/dashboard", "/threads", "/history", "/p/[id]"}
