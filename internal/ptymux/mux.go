...
func (mx *Mux) switchTo(i int) {
	...
	// claude turns mouse on (so it scrolls itself); codex/gemini/shells don't → the terminal
	// keeps native selection + scroll, so copy/paste works (incl. Apple Terminal).
