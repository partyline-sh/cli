...
func DaemonStream(ctx context.Context, base, token string, onReady func(), onLaunch func(LaunchEvent), onAccepted func(LaunchEvent), onRun func(RunEvent), onKill func(string), onRestart func()) error {
