...
func main() {
	...
	if len(os.Args) > 1 {
		...
		fmt.Fprintln(os.Stderr, "commands: start, new, join, party, llms, thread, project, work, plan, crank, wt, daemon, org, skill, state, tray, sessions, login, logout, whoami, man, upgrade, version, help")
