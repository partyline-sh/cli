...
func deliverToAskingSession(mx peerDeliverTarget, m peerMessage, paste func(sess *ptysess.Session, block string, submit bool, confirm func() string) bool) (deliverMode, string) {
...
func waitForPasteToLand(sess *ptysess.Session, block string) {
...
func pasteBlock(sess *ptysess.Session, block string, submit bool, confirm func() string) bool {
